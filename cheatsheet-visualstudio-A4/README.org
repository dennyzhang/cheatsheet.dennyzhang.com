...
- Related posts: [[https://cheatsheet.dennyzhang.com/cheatsheet-git-A4][Git CheatSheet]], [[https://cheatsheet.dennyzhang.com/cheatsheet-mercruial-A4][Mercruial/hg CheatSheet]]
File me [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/issues][Issues]] or star [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com][this repo]].
** Visual Studio Summary
| Name                        | Command                  |
|-----------------------------+--------------------------|
| Enter command mode          | Cmd+Shift+P              |
| Detect visual studio issues | =>doctor:Fix My VS Code= |
** More Resources
