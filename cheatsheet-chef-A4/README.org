* CheatSheet: Chef Automation                                         :Linux:
:PROPERTIES:
:type:     linux, tool
...
- PDF Link: [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-chef-A4/cheatsheet-chef-A4.pdf][cheatsheet-chef-A4.pdf]], Category: [[https://cheatsheet.dennyzhang.com/category/linux/][linux]]
...
| Name                             | Command                                       |
|----------------------------------+-----------------------------------------------|
| Create a file with given content | [[https://docs.chef.io/resources/file/][Link: file resource]]                           |
| Chef install package             | [[https://docs.chef.io/resources/package/#syntax][Link: chef package resource]]                   |
| Chef conditional update          |                                               |
| Chef create file/directory       | [[https://docs.chef.io/resources/file/][Link: file resource]], [[https://docs.chef.io/resources/directory/][Link: directory resource]] |
** More Resources
...
#+LATEX_HEADER: \lhead{\href{https://cheatsheet.dennyzhang.com/cheatsheet-chef-A4}{Blog URL: https://cheatsheet.dennyzhang.com/cheatsheet-chef-A4}}
#+AUTHOR: Denny Zhang
...
#+LINK_UP:   
#+LINK_HOME: 
* TODO chef get centos version                                     :noexport:
* TODO chef update: chef -i                                        :noexport:
* TODO chefctl -i with custom json                                 :noexport:
* chef copy files                                                  :noexport:
* chef-shell                                                       :noexport:
