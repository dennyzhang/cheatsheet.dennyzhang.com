...
| heptio backup volume | Backup is done at PV layer(block), instead of PVC layer(Posix filesystem). |
...
[[https://cheatsheet.dennyzhang.com/cheatsheet-k8s-backup-A4][https://raw.githubusercontent.com/dennyzhang/cheatsheet.dennyzhang.com/master/cheatsheet-k8s-backup-A4/ark-backup-process.png]]
** heptio ark cli
| Name                    | Command                                               |
|-------------------------+-------------------------------------------------------|
