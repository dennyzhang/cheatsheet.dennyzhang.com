...
** CANCELED 处理logitech的mouse and keyboard
...
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO 前院的桔树死了,找市政府换一棵更合适的树                    :noexport:
* TODO Return xfinity kit                                          :noexport:
* TODO Detect Garage door                                          :noexport:
...
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO [#A] 炉子开不了                                             :noexport:
* TODO [#A] 后院没有自动喷水                                       :noexport:
* TODO [#A] Merge 401K                                             :noexport:
* TODO [#A] 次卧有煤气味                                           :noexport:
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* [#A] peach tree is sick                                          :noexport:
* TODO 买棵果树, 种在前院                                          :noexport:
* TODO 主卧买类似次卧那样比较舒服的被子                            :noexport:
* TODO 改造garage来停两辆车                                        :noexport:
* TODO ring detect garage door state                               :noexport:
* TODO [#A] build an ADU                                           :noexport:
...
* TODO [#A] clean laundry filter                                   :noexport:
https://www.youtube.com/watch?v=7x362qb0IRk
https://www.youtube.com/watch?v=WxxOtXTiDUY
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* HALF 买做前后院用的手套                                          :noexport:
* HALF peach tree leaf curl                                        :noexport:
* HALF 买月季的药: Black Spot on Roses                             :noexport:
...
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO lemon tree yellow                                           :noexport:
* TODO LG Front Load Washer - door seal                            :noexport:
...
* TODO bugs in trash can during the summer time                    :noexport:
* HALF deal with fruit flies                                       :noexport:
https://www.youtube.com/watch?v=WwM0TA5N61U
https://www.youtube.com/watch?v=wBcd4_OgG7I
- clean
- bait
* TODO citrus leaf curl                                            :noexport:
https://www.youtube.com/watch?v=zDD7NYS6kE4

https://www.youtube.com/watch?v=Rl96SLtqvHc

https://www.youtube.com/watch?v=DoTL6iRWghg

https://www.youtube.com/watch?v=5bGG3ok6HpA

- fruit
- prune infected leaves
- feed it

Causes of citrus curling
- Pests attack
- Water stress
- Fungal Disease
- Bacterial Blast
- Potassium Deficiencies
* todo citrus yellow leaf                                          :noexport:
* TODO lg washing machine wm8000hva manual                         :noexport:
https://www.lg.com/us/support/products/documents/WM8000%20Manual.pdf
* TODO 次卧室厕所自己会冲水                                        :noexport:
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
...
* TODO [#A] Check HSA monthly administration fees
...
* TODO reset hot water machine                                     :noexport:
