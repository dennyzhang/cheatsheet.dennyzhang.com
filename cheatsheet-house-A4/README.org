...
* TODO cancel Amazon prime service
* TODO change heater滤芯                                           :noexport:
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
...
* TODO [#A] Tear down the ikea shelf                               :noexport:
* TODO [#A] apply two credit cards: costco and chase safari        :noexport:
...
* TODO Loan for housing                                            :noexport:
12W, 24W
...
https://www.homeadvisor.com/
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO get a electric lawn mover from criaglist                    :noexport:
freemont: $215
...
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO toliet rolling sticker                                      :noexport:
* TODO [#B] lawnmover                                              :noexport:
...
* [#A] water heater pilot won't light                              :noexport:
...
Services Include: Water Heater - Repair or Service in San Jose, CA
 ...
 Write a review
 (408) 828-6700
* replace a water heater                                           :noexport:
