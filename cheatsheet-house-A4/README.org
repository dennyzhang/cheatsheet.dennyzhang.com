* CheatSheet: Buy A House In US                                        :Life:
:PROPERTIES:
:type:     house
...
** Get Pre-approve letter for mortgage
| Name               | Summary |
|--------------------+---------|
| Need 3 creditlines |         |
** Checklist before placing a order
| Name                   | Summary                                 |
|------------------------+-----------------------------------------|
...
https://github.com/trimstray/house-essentials
...
* TODO To lower the maintainance effort, what I need to do?        :noexport:
