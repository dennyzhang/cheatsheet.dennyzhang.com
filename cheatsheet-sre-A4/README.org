...
|  16 | Figure out who has logged to server now and previously? |                                            |
...
|   5 | [[https://www.tecmint.com/systemd-replaces-init-in-linux/][How do you feel about systemd?]]                                                     | Init processes start serially, consequently delayed and long booting time |
...
|   9 | With =bg=, process goes to background. But in another terminal, =jobs= won't show? |                                                                           |
...
* TODO How to choose RAID levels for different scenarios?          :noexport:
