...
| Cheatsheet | [[https://cheatsheet.dennyzhang.com/cheatsheet-shell-A4][Shell CheatSheet]]                                                                       |
** Good Mindsets
| Num | Name                            | Summary                      |
|-----+---------------------------------+------------------------------|
...
|   7 | How reliable =history= command is? And how to alleviate the problem? |                                                                           |
|   8 | How to setup http proxy with SLA for different traffic?              |                                                                           |
#+TBLFM: $1=@-1$1+1;N
...
|   2 | Which port ICMP is using?             | Neither TCP or UDP. [[https://learningnetwork.cisco.com/thread/120555][Link]] |
#+TBLFM: $1=@-1$1+1;N
