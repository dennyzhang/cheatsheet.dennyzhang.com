...
| Client libraries            | Instrument application code. [[https://raw.githubusercontent.com/dennyzhang/cheatsheet.dennyzhang.com/master/cheatsheet-prometheus-A4/prometheus-python-example.py][Link: prometheus-python-example.py]]                     |
...
| cadvisor                       | http://$node_ip:10255/metrics/cadvisor     | [[https://raw.githubusercontent.com/dennyzhang/cheatsheet.dennyzhang.com/master/cheatsheet-prometheus-A4/cadvisor-sample.txt][Link: cadvisor-sample.txt]]                     |
| node-exporter                  | http://$node_ip:9100/metrics               | [[https://raw.githubusercontent.com/dennyzhang/cheatsheet.dennyzhang.com/master/cheatsheet-prometheus-A4/node-exporter-sample.txt][Link: node-exporter-sample.txt]]                |
| kubelet                        | http://$kubelet_ip:10255/metrics           | [[https://raw.githubusercontent.com/dennyzhang/cheatsheet.dennyzhang.com/master/cheatsheet-prometheus-A4/kubelet-sample.txt][Link: kubelet-sample.txt]]                      |
| kube-dns                       | http://$kube_dns_addon_ip:10054/metrics    | [[https://raw.githubusercontent.com/dennyzhang/cheatsheet.dennyzhang.com/master/cheatsheet-prometheus-A4/kube-dns-sample.txt][Link: kube-dns-sample.txt]]                     |
| kube-state-metrics http-metric | http://$kube_state_metric_svc:8080/metrics | [[https://raw.githubusercontent.com/dennyzhang/cheatsheet.dennyzhang.com/master/cheatsheet-prometheus-A4/kube-state-metrics-http-sample.txt][Link: kube-state-metrics-http-sample.txt]]      |
| kube-state-metrics telemetry   | http://$kube_state_metric_svc:8081/metrics | [[https://raw.githubusercontent.com/dennyzhang/cheatsheet.dennyzhang.com/master/cheatsheet-prometheus-A4/kube-state-metrics-telemetry-sample.txt][Link: kube-state-metrics-telemetry-sample.txt]] |
...
| topk query                                                     | [[https://raw.githubusercontent.com/dennyzhang/cheatsheet.dennyzhang.com/master/cheatsheet-prometheus-A4/query-topk.txt][Link: query-topk.txt]]                                      |
| aggregate                                                      |                                                           |
| join                                                           |                                                           |
| cut                                                            |                                                           |
| slice                                                          |                                                           |
