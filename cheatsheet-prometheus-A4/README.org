...
| cadvisor           | http://$node_ip:10255/metrics/cadvisor  |
| node-exporter      | http://$node_ip:9100/metrics            |
| kubelet            | http://$kubelet-ip:10255/metrics        |
| kube-dns           | http://$kube-dns-addon-ip:10054/metrics |
| kube-state-metrics |                                         |
** More Resources
...
* TODO where is pod 110 limitation is set?                         :noexport:
