...
** Kubernetes Common Metrics & Samples
| Name                           | Command                                                                                             |
|--------------------------------+-----------------------------------------------------------------------------------------------------|
...
| kube-state-metrics http-metric | http://$kube-state-metric-svc:8080/metrics, [[https://raw.githubusercontent.com/dennyzhang/cheatsheet.dennyzhang.com/master/cheatsheet-prometheus-A4/kube-state-metrics-http-sample.txt][Sample Metrics: kube-state-metrics-http-sample.txt]]      |
| kube-state-metrics telemetry   | http://$kube-state-metric-svc:8081/metrics, [[https://raw.githubusercontent.com/dennyzhang/cheatsheet.dennyzhang.com/master/cheatsheet-prometheus-A4/kube-state-metrics-telemetry-sample.txt][Sample Metrics: kube-state-metrics-telemetry-sample.txt]] |
** Prometheus Concepts
| Name         | Command |
|--------------+---------|
| Target       |         |
