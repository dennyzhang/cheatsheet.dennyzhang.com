* CheatSheet: IT Career Path                                           :Life:
:PROPERTIES:
:type:     life
...
| Tech Community evangelist         | Model: [[https://aws.amazon.com/blogs/aws/author/jbarr/][Jeff Barr in AWS]]                                                          |
| Tech super star                   | Model: [[https://en.wikipedia.org/wiki/Jeff_Dean_(computer_scientist)][Jeff Dean in Google]]. Solve tech puzzles that no one else can do           |
...
#+LATEX_HEADER: \lhead{\href{https://cheatsheet.dennyzhang.com/cheatsheet-it-career-A4}{Blog URL: https://cheatsheet.dennyzhang.com/cheatsheet-it-career-A4}}
#+AUTHOR: Denny Zhang
