...
- PDF Link: [[https://github.com/dennyzhang/cheatsheet-sed-A4/blob/master/cheatsheet-sed-A4.pdf][cheatsheet-sed-A4.pdf]], Category: [[https://cheatsheet.dennyzhang.com/category/kubernetes/][kubernetes]]
...
** TODO Only replace the first match	
** TODO Identify multiple lines
** TODO Add content after nth line
