...
| Reference | [[https://access.redhat.com/documentation/en-us/openshift_container_platform/3.11/html/cli_reference/cli-reference-basic-cli-operations][Link: OC CLI Operations]], [[https://cheatsheet.dennyzhang.com/cheatsheet-pks-A4][PKS CheatSheet]]                                        |
...
** OpenShift Additional Object Types & CRD
| Name             | Command          |
|------------------+------------------|
| Project          | =oc get project= |
| Build            | =oc get build=   |
| BuildConfig      | =oc get bc=      |
