...
| Reference                | [[https://docs.okd.io/latest/minishift/index.html][Link: Minishift]], [[https://cheatsheet.dennyzhang.com/cheatsheet-pks-A4][PKS CheatSheet]]                                                            |
...
| Control dashboard           | https://192.168.99.100:8443, system/admin                                        |
** Minishift Footprint
| Process                              | Command                                                                                         |
|--------------------------------------+-------------------------------------------------------------------------------------------------|
...
| Explain concepts for me                           | =oc explain pod=, =oc explain replicaset=                     |
** OC - Admin
| Name                                       | Command                              |
|--------------------------------------------+--------------------------------------|
| Login/logout                               | =oc login=, =oc logout=, =oc whoami= |
| List route                                 | =oc get route=                       |
| List all object types                      | =oc types=                           |
...
| Name                                 | OpenShift                   | PKS                     |
|--------------------------------------+-----------------------------+-------------------------|
| VM lifecycle management              | Ansible                     | Bosh                    |
| Deployment experience                | [[https://docs.okd.io/latest/minishift/getting-started/quickstart.html][Minishift]]                   |                         |
| Developers                           | Projects/Build/Applications | N/A                     |
| Storage                              | Gluster/Ceph                | VMware vSAN             |
| Network                              |                             | NSX-T/Flannel           |
| Multi-cloud/Virtualization           |                             | On-prem Vsphere/GCP/AWS |
| Bare Metal                           | Yes                         | N/A                     |
| HA: control plane                    |                             |                         |
| Efficiency: control plane deployment |                             |                         |
| Efficiency: Create k8s cluster       |                             |                         |
| Efficiency: Create k8s workload      |                             |                         |
** Openshift CLI Online Help
#+BEGIN_EXAMPLE
/User/zdenny > oc --help
OpenShift Client
