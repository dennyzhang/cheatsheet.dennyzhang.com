...
** TODO jenkins load the ssh key: Credentials Plugin: http://injenkins.carol.ai:48080/view/All/job/dennytest/4/console
...
http://injenkins.carol.ai:48080/view/TeamWise/job/DeployDigitalOceanMDMQACluster/42/console
...
curl -X GET http://dennyzhang:lrpChangeMe1@bematech-do-jenkins.carol.ai:18080/job/dennytestRehearsal/config.xml -o mylocalconfig.xml

curl -X POST http://dennyzhang:lrpChangeMe1@bematech-do-jenkins.carol.ai:18080/job/dennytestRehearsal/config.xml --data-binary "@mymodifiedlocalconfig.xml"
** TODO why has_error variable hasn't passed: http://bematech-do-jenkins.carol.ai:18080/job/CheckDNSPropagation/14/console
** TODO jenkins docker image: why /var/jenkins_home/.bashrc folder is missing?
** TODO [#A] Blog: use groovy to reconfigure ThinBackup, and inject credential
*** create slack token
...
*** #  --8<-------------------------- separator ------------------------>8-- :noexport:
*** DONE hello world
   CLOSED: [2017-08-17 Thu 11:39]
String message = 'Hello from Groovy'
println message
*** DONE [#A] groovy get environment variable
  CLOSED: [2017-06-11 Sun 18:15]
https://stackoverflow.com/questions/40215394/how-to-get-environment-variable-in-jenkins-groovy-script-console
...
#+END_EXAMPLE
*** DONE groovy list
  CLOSED: [2017-06-27 Tue 21:17]
http://groovy-lang.org/groovy-dev-kit.html#_list_literals
*** DONE Groovy multi-line String?
  CLOSED: [2017-08-17 Thu 11:42]
https://stackoverflow.com/questions/5079797/whats-wrong-with-groovy-multi-line-string
http://grails.asia/groovy-multiline-string
def a = """test
test
test"""
*** DONE groovy string to list: string.split("\n")
  CLOSED: [2017-08-17 Thu 15:32]
...
print l.join("a")
*** DONE groovy list to string: l.join(";")
   CLOSED: [2017-08-17 Thu 15:32]
...
*** DONE groovy loop map
  CLOSED: [2017-12-29 Fri 23:19]
#+BEGIN_EXAMPLE
...
#+END_EXAMPLE
*** DONE groovy use dictionary
  CLOSED: [2017-12-29 Fri 22:41]
#+BEGIN_EXAMPLE
Amrit [10:37 PM]
trying to figure out whether its possible to iterate stages in a Jenkinsfile using hash?


Amrit [10:37 PM]
added this Plain Text snippet: sample
def sampleMap = ['Key#1':'Value#1', 'Key#2':'Value#2']
println sampleMap['Key#1']
// itertate over stages
...
[10:41]
@Amrit This looks good in my test.
#+END_EXAMPLE
*** DONE groovy get hostname by ip
  CLOSED: [2018-04-06 Fri 17:28]
...
*** DONE How to easily test groovy script: get script console from Jenkins: Manage Jenkins -> Script Console
   CLOSED: [2018-04-06 Fri 17:27]
...
** TODO Blog: use groovy to configure ThinBackup plugin
...
** TODO jenkinsbot token
xoxp-239480382723-238904850256-277528043553-4049bf10fc5f4997e8eafc54998787ee
...
** HALF copy json folder across nodes: http://bematech-do-jenkins.carol.ai:18080/job/CopyFolderFromNode1ToNode2/
...
** HALF [#A] doc: why vm shutdown has failed: http://bematech-do-jenkins.carol.ai:18080/job/RunCommandOnServers/187/
** TODO [#A] problem: Fail to shutdown couchbase nodes: http://bematech-do-jenkins.carol.ai:18080/job/RunCommandOnServers/181/console
...
** TODO http://bematech-do-jenkins.carol.ai:18080/job/CopyFolderFromNode1ToNode2/
** TODO mute the output of token: http://bematech-do-jenkins.carol.ai:18080/job/CreateAndProvisionVMInCloud/176/console
** TODO restart es: console output is very slow to show: http://bematech-do-jenkins.carol.ai:18080/job/RestartOneESSafely/5/console
