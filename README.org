...
* TODO Create symol link: https://cheatsheet.dennyzhang.com/cheatsheet-kubernetes :noexport:
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO support emoji usage                                         :noexport:
* TODO why no tag is generated now: https://cheatsheet.dennyzhang.com/cheatsheet-kubernetes :noexport:
...
*** DONE Update link script: pdf, and export_file_name
    CLOSED: [2018-09-03 Mon 17:35]
* TODO org-mode cheatsheet                                         :noexport:
* TODO enable people to better search; https://devhints.io/        :noexport:
* TODO [#A] use two columns instead of one: https://devhints.io/bash
