...
* Contact CheatSheets                                         :noexport:BLOG:
:PROPERTIES:
:type:     life
:END:
...
* [#A] Submit PR to related communities: docker/concourse          :noexport:
https://concourse-ci.org/exposing.html
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
...
* TODO Improve https://cheatsheet.dennyzhang.com/cheatsheet-docker-A4 :noexport:
...
* TODO vagrant cheatsheet: https://jimmysong.io/cheatsheets/vagrant :noexport:
...
ansible
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO [#A] update health cheatsheet: /Users/mac/Dropbox/org_data/life/life.org :noexport:
* TODO Update cheatsheet https://cheatsheet.dennyzhang.com/cheatsheet-wordpress-A4 :noexport:
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO update: https://cheatsheet.dennyzhang.com/cheatsheet-vrops-A4 :noexport:
* TODO update https://cheatsheet.dennyzhang.com/cheatsheet-wordpress-A4 :noexport:
* TODO update https://cheatsheet.dennyzhang.com/cheatsheet-mongodb-A4 :noexport:
* TODO update https://cheatsheet.dennyzhang.com/cheatsheet-public-db-A4 :noexport:
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO github markdown format: https://github.com/dennyzhang/cheatsheet-knative-A4/blob/master/README.md :noexport:
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO [#A] publish cheatsheet for web browser                     :noexport:
** TODO print webpage as a screenshot image
* TODO cheatsheet confluence: JIR                                  :noexport:
** JIRA search tickets resolved in the past one month
* TODO cheatsheet: vke cli                                         :noexport:
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
...
* TODO linux security cheatsheet: https://bitbucket.org/devops_sysops/cheatsheetcollection/src/a4b5d9acc0a852254a2eb8719068f9361d99e426/Security/Selinux.md?fileviewer=file-view-default :noexport:
...
* TODO rkt: https://rocket.readthedocs.io/en/latest/Documentation/commands/ :noexport:
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO helm cheatsheet                                             :noexport:
https://bitbucket.org/devops_sysops/cheatsheetcollection/src/a4b5d9acc0a852254a2eb8719068f9361d99e426/Containers/Helm.md?fileviewer=file-view-default
