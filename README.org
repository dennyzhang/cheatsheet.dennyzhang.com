...
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO google adsense image icon: https://code.dennyzhang.com/     :noexport:
...
* TODO Improve https://cheatsheet.dennyzhang.com/cheatsheet-dns-A4 :noexport:
* TODO Improve https://cheatsheet.dennyzhang.com/cheatsheet-jenkins-A4 :noexport:
* TODO Improve https://cheatsheet.dennyzhang.com/cheatsheet-couchbase-A4 :noexport:
* TODO Improve https://cheatsheet.dennyzhang.com/cheatsheet-elasticsearch-A4 :noexport:
* TODO Improve https://cheatsheet.dennyzhang.com/cheatsheet-nagios-A4 :noexport:
* TODO Improve https://cheatsheet.dennyzhang.com/cheatsheet-visa-A4 :noexport:
* TODO Improve https://cheatsheet.dennyzhang.com/cheatsheet-chef-a4 :noexport:

* TODO Improve https://cheatsheet.dennyzhang.com/cheatsheet-process-A4 :noexport:
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO github: try to fold things: https://github.com/LeCoupa/awesome-cheatsheets :noexport:
* TODO [#A] blog link: avoid going to an external link: [[url-external: doesn't work for org-ruby: https://cheatsheet.dennyzhang.com/cheatsheet-git
...
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO cheatsheet column: set the minimium width: https://github.com/dennyzhang/cheatsheet-kubernetes-A4 :noexport:
