...
* TODO [#A] blog post: avoid open a new link                      :IMPORTANT:
...
* HALF Improve https://cheatsheet.dennyzhang.com/cheatsheet-iptables-A4
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO change github repo to directory: https://github.com/dennyzhang/cheatsheet-living-in-ca
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
