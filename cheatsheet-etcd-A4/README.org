...
| Name                         | Command                              |
|------------------------------+--------------------------------------|
| Explore etcd in minikube env | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-etcd-A4/k8s-etcd-minikube][cheatsheet-etcd-A4/k8s-etcd-minikube]] |
** More Resources
