...
* TODO Which signals can be catch?                                 :noexport:
* TODO Difference between switch and router?                       :noexport:
L2, L3
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
...
* TODO How does the Linux kernel run a program                     :noexport:
...
* TODO Program startup process in userspace                        :noexport:
https://0xax.gitbooks.io/linux-insides/Misc/linux-misc-4.html
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO systemd vs init.d vs service                                :noexport:
https://www.tecmint.com/systemd-replaces-init-in-linux/
https://linoxide.com/linux-command/systemd-vs-sysvinit-cheatsheet/

Motivation from init process to systemd: avoid all the un-necessary delay.
