...
#+END_HTML
** Papers Of Well-Known Products
| Name                                  | Summary |
|---------------------------------------+---------|
| Dynamo - HA K/V store                 | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-featuredesign-A4/paper/dynamo-amazon.pdf][paper]]   |
| Chubby - Lock service                 | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-featuredesign-A4/paper/chubby-osdi06.pdf][paper]]   |
| Cassandra - Decentralized storage     | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-featuredesign-A4/paper/cassandra-facebook.pdf][paper]]   |
| Kafka - distributed messageing system | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-featuredesign-A4/paper/kafka-linkedin.pdf][paper]]   |
| Bigtable - distributed storage        | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-featuredesign-A4/paper/bigtable-google.pdf][paper]]   |
| Zookeeper - Cooridnation              | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-featuredesign-A4/paper/zookeeper.pdf][paper]]   |
| Spanner - Globally-distributed db     | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-featuredesign-A4/paper/spanner-google.pdf][paper]]   |
| Google file system                    | [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-featuredesign-A4/paper/the-google-file-system.pdf][paper]]   |
...
| Num | Name                             | Summary                                                                 |
|-----+----------------------------------+-------------------------------------------------------------------------|
|   1 | Deep dive into your daily work   | Unify and normalize problems from daily work                            |
|   2 | Learn the work of your coleagues | Indirect working experience also help                                   |
|   3 | Popular products under the hood  | Once you notice an interesting feature, think about how it's supported? |
|   4 | Read engineering blogs           | Especially for big companies                                            |
|   5 | Tools under the hood             | Common tools/frameworks                                                 |
|   6 | Try tools                        | Use cases; Alternatives; Pros and Cons                                  |
|   7 | Read papers                      | Best practices in papers                                                |
|   8 | Try new things                   | Gain hands-on experience; evaluate alternatives                         |
|   9 | Datastore & OS                   | Learn how databases and operating systems work                          |
|  10 | Language implementation          | Deep dive into one programming language. Java, Python, Golang, etc      |
#+TBLFM: $1=@-1$1+1;N
...
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO How redis is implemented?                                   :noexport:
* TODO How kafaka is implemented?                                  :noexport:
