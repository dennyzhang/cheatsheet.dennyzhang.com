...
|   3 | Abstract design                                 | Sketch main components, explain workflow, avoid too deep for details |
|   4 | Bottlenecks: *Key challenges* + *Trade-Offs*    | Valid reasoning to justify your proposals                            |
|   5 | [[https://docs.microsoft.com/en-us/azure/architecture/guide/pillars][Scale your design]]                               | Availability, Scalability, Resiliency, Security, Management, etc     |
#+TBLFM: $1=@-1$1+1;N
...
|   3 | [[https://architect.dennyzhang.com/design-parkinglot/][Design: A Parking Lot Service]]              | [[https://github.com/donnemartin/system-design-primer/blob/master/solutions/object_oriented_design/parking_lot/parking_lot.ipynb][link]]                                         |
|   4 | [[https://architect.dennyzhang.com/design-elevator/][Design: An Elevator Service]]                |                                              |
|   5 | [[https://architect.dennyzhang.com/design-uber/][Design: Uber Backend]]                       |                                              |
|   6 | Design twitter news feed                   | [[https://medium.com/@narengowda/system-design-for-twitter-e737284afc95][link]]                                         |
|-----+--------------------------------------------+----------------------------------------------|
...
|  11 | Design a voice conference system           |                                              |
...
|  20 | [[https://architect.dennyzhang.com/design-url-redirect/][Design: A URL Redirecting Feature]]          |                                              |
|  21 | Design Google PageRank                     |                                              |
|  22 | Design messaging/notification system       |                                              |
|  23 | Design search post system                  |                                              |
|  24 | Design memcache                            |                                              |
|  25 | Design typeahead                           |                                              |
