...
|   3 | For common tools/frameworks, understand behind the hook                                                  |
|   4 | Try tools. What problem it solves, what its alternatives are, and what some common pros and cons may be. |
|   5 | Keep researching the alternatives to a technology. e.g, rabbitmq vs kafaka, memcached vs redis           |
#+TBLFM: $1=@-1$1+1;N
