...
| subquery                        | [[https://code.dennyzhang.com/immediate-food-delivery-ii][Leetcode: Immediate Food Delivery II]]                                                      |
| SQL problems                    | [[https://code.dennyzhang.com/review-sql][#sql]]                                                                                      |
** SQL Statement
| Name                               | Command                                                         |
|------------------------------------+-----------------------------------------------------------------|
