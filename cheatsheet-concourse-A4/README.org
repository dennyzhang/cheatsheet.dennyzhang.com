...
* #  --8<-------------------------- separator ------------------------>8-- :noexport:
* TODO fail to fly pipeline                                        :noexport:
https://github.com/concourse/concourse/issues/2582
#+BEGIN_EXAMPLE
   /Users/zdenny/Dropbox/private_data/work/vmware/code/pks-ci/ci  fly --target pks set-pipeline --pipeline wavefront-proxy-release  --config <(erb /Users/zdenny/Dropbox/private_data/work/vmware/code/pks-ci/ci/wavefront-proxy-release.yml) --load-vars-from <(ansible-vault view --vault-password-file vaultpass /Users/zdenny/Dropbox/private_data/work/vmware/code/pks-ci/ci/secrets/common-secrets.yml) --load-vars-from <(ansible-vault view --vault-password-file vaultpass /Users/zdenny/Dropbox/private_data/work/vmware/code/pks-ci/ci/secrets/wavefront-proxy-release-secrets.yml) -n oratos-vmware
error: forbidden
#+END_EXAMPLE
