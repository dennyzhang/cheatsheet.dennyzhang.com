...
| [[https://concourse-ci.org/managing-pipelines.html#fly-get-pipeline][Get pipeline definition]]           | =fly -t $target get-pipeline -p $job-name > job.yaml=                              |
...
| Name                                          | Summary                                                                                    |
|-----------------------------------------------+--------------------------------------------------------------------------------------------|
| github-release resource get the old tag       | =fly -t $target check-resource -r $pipeline-name/$resource-name -f tag:$tag= [[https://stackoverflow.com/questions/41108427/concourse-github-release-resource-cannot-find-older-versions-or-tags][Link]]          |
...
** Concourse Opportunities                                         :noexport:
| Name                                                 | Summary                                                                                        |
|------------------------------------------------------+------------------------------------------------------------------------------------------------|
