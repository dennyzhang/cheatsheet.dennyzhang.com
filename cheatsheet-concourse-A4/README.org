...
- PDF Link: [[https://github.com/dennyzhang/cheatsheet-concourse-A4/blob/master/cheatsheet-concourse-A4.pdf][cheatsheet-concourse-A4.pdf]]
...
| Get pipeline definition | =fly -t $target get-pipeline -p $job-name > job.yaml= |
