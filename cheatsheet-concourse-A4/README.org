...
| Name          | Summary                                      |
|---------------+----------------------------------------------|
| Git repo      | =git-resource= example: [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/tree/master/cheatsheet-concourse-A4/example-git.yml][example-git.yml]] [[https://github.com/concourse/git-resource][link]] |
