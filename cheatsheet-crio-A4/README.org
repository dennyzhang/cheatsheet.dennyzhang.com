...
| Name                           | Summary                                                            |
|--------------------------------+--------------------------------------------------------------------|
| cri-o                          | Container runtime for dockerd alternative. Initialized from Redhat |
...
[[https://cheatsheet.dennyzhang.com/cheatsheet-crio-A4][https://raw.githubusercontent.com/dennyzhang/cheatsheet.dennyzhang.com/master/cheatsheet-crio-A4/crio-architecture.png]]
** podman
| Name                       | Summary                           |
|----------------------------+-----------------------------------|
