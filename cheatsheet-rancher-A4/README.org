...
- PDF Link: [[https://github.com/dennyzhang/cheatsheet.dennyzhang.com/blob/master/cheatsheet-rancher-A4/cheatsheet-rancher-A4.pdf][cheatsheet-rancher-A4.pdf]], Category: [[https://cheatsheet.dennyzhang.com/category/tools/][tools]]
...
| Reference                | [[https://rancher.com/][Link: rancher.com]]                                               |
** Rancher Source Code
| Name                       | Command                |
|----------------------------+------------------------|
| Rancher API Layer          | [[https://github.com/rancher/norman][GitHub: rancher/norman]] |
| Rancher Kubernetes Release | [[https://github.com/rancher/rke][GitHub: rancher/rke]]    |
** Rancher Footprint
#+BEGIN_EXAMPLE
